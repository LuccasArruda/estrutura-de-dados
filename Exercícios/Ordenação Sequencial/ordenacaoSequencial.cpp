...
int pesquisaSequencial(Aluno *vetorAlunos, int quantidadeAlunos, int ra){
	int i;
	while((vetorAlunos[i].ra != ra) && (i < quantidadeAlunos)){
		i++;
	}
...
int main () {
    ...
    indiceRetornado = pesquisaSequencial(vet, n, ra);   // pesquisa pelos dados da última submissão da equipe 
